  ...
  return (
    <div className="flex flex-col md:flex-row gap-3 md:gap-4">
      ...
      <div className="grid grid-cols-2 gap-2 md:flex md:w-auto">
        <select
          className="px-3 md:px-4 py-2 md:py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-black outline-none shadow-sm font-medium text-[11px] md:text-sm appearance-none pr-8"
          style={selectStyles}
          value={filterStatus}
